...
const DreamVacation = () => {
  ...
  return (
    <div className="flex flex-col mt-14 px-4 mx-auto max-w-screen-xl sm:ml-[175px]">
      {/* Title */}
      <h1 className="text-2xl sm:text-3xl font-semibold mb-2 text-center sm:text-left sm:ml-0 text-gray-800 dark:text-white">
        Enjoy your dream vacation
      </h1>

      {/* Description */}
      <p className="text-gray-600 dark:text-gray-400 mb-10 max-w-xl text-center sm:text-left sm:ml-0">
        ...
        {category?.map((destination, index) => {
          ...
          return (
            <div key={index} className="text-center w-full sm:w-[18rem]">
              ...
              <h2
                className="text-lg font-semibold mt-2 cursor-pointer text-gray-800 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200"
